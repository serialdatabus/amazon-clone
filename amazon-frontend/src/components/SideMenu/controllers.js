export const resetSideMenuState = ({setsubcategoriesisopened,setshowallcategories}) => {
  ...
  export const openSubCategories = ({slug , setcurrentSelectedCategory , setsubcategoriesisopened }) => {
